...
public class VentanaBETAAAExpedienteProveedor extends javax.swing.JPanel {
    ...
    public VentanaBETAAAExpedienteProveedor(Proveedor supplier, Usuario currentUser) throws Exception {
